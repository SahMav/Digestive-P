...
function updatePopup(){
  ...
  if(syncVideo.ended){
    popupType = 'end'
    popupText.textContent = "Thank you for finishing this lecture! \r\n \r\n Your completion code is \"DigDone!\". Return to the survey, copy and paste the completion code in the text box to move on to the next step!"
...
function handlePopupButton(){
  ...
  if(popupType == 'switch'){
    ...
    taskWindow.location.href = 'https://ubc.ca1.qualtrics.com/jfe/form/SV_en6tJD7SpFsxk4C';
  }
  if(popupType == 'end'){
    popupContainer.style.display = "none"
